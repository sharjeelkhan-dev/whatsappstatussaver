package com.example.whatsappstatussaver.di

import android.content.Context
import androidx.room.Room
import com.example.whatsappstatussaver.data.local.StatusDatabase
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideReminderDao(database: StatusDatabase): com.example.whatsappstatussaver.data.local.dao.ReminderDao {
    ...
    fun provideStorageRepository(
        ...
        appSettings: com.example.whatsappstatussaver.data.local.datastore.AppSettings
    ): StorageRepository {
