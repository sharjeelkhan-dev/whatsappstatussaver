package com.sharjeel.whatsappstatussaver.ui.navigation
...
fun WhatsAppStatusSaverNavHost(
    ...
    NavHost(
        ...
        composable(Screen.Splash.route) {
            com.sharjeel.whatsappstatussaver.ui.splash.SplashScreen(
        ...
        composable(Screen.Home.route) {
            com.sharjeel.whatsappstatussaver.ui.home.HomeScreen(
        ...
        composable(Screen.DirectChat.route) {
            com.sharjeel.whatsappstatussaver.ui.chat.DirectChatScreen(onNavigateBack = { navController.popBackStack() })
        }
        composable(Screen.SavedFiles.route) {
            com.sharjeel.whatsappstatussaver.ui.saved.SavedFilesScreen(
                onNavigateBack = { navController.popBackStack() },
                onNavigateToViewer = { uri, type, name ->
        ...
        composable(Screen.Reminder.route) {
            com.sharjeel.whatsappstatussaver.ui.reminder.ReminderScreen(onNavigateBack = { navController.popBackStack() })
        }
        composable(Screen.Settings.route) {
            com.sharjeel.whatsappstatussaver.ui.settings.SettingsScreen(
                onNavigateBack = { navController.popBackStack() }
            )
        }
        composable(
            ...
            val statusViewModel: com.sharjeel.whatsappstatussaver.ui.status.StatusViewModel = androidx.hilt.navigation.compose.hiltViewModel()
            com.sharjeel.whatsappstatussaver.ui.viewer.MediaViewerScreen(
