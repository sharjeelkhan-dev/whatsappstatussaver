...
import com.sharjeel.whatsappstatussaver.domain.usecase.ManageFavoritesUseCase
...
class SavedFilesViewModel @Inject constructor(
    ...
    private val dao: com.sharjeel.whatsappstatussaver.data.local.dao.SavedMediaDao,
    private val compressVideoUseCase: com.sharjeel.whatsappstatussaver.domain.usecase.CompressVideoUseCase
) : ViewModel() {
